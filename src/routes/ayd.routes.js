...
route.post("/new", upload.single('bannerImage'), verifyToken, aydController.createAyd);
route.get("/currentAyd", aydController.getCurrentAyd);
route.get("/:aydId", aydController.getAyd);
route.put("/:aydId", upload.single('bannerImage'), verifyToken, aydController.updateAyd)
